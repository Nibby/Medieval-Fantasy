 ...
 *
 * This is the database class for tilesets.
 * No need to keep the tileset instances as their only
 * purpose is to supply their tiles with images.
 *
 * Originally I thought this was not required, but turns out tile
 * frames & tile animation is dependant on them.
 */
public class TilesetDatabase {

    /**
     * This method should only be invoked upon the init() method in
     * the main game class.
     *
     * As the name implies, this will initiate the entie tileset loading
     * sequence.
     */
    ...
    public static TilesetDatabase getDatabase() { return database; }
