 ...
 *
 * This is a single generic representation of a usual tile.
 * Loaded from XML, it has a properties sheet that contains collision information
 * and a few methods concerning game logic.
 *
 * A collection of tiles belong in tilesets, but it is also universally
 * registered on a database since tiles aren't strictly limited to being in a tileset.
 */
public class Tile {
     ...
     * @param tileFrames The animation frames of the tile described as x,y co-ordinates on the
     *                   given spritesheet.
     *
     * @param properties A single condensed string of properties, will be split and placed inside
     *                   'properties'
     */
