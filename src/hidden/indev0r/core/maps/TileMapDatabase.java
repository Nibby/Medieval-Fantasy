 ...
 *
 * This is the database class that loads and registers all the
 * available tile maps in the 'data/maps' directory.
 *
...
public class TileMapDatabase {
     ...
     * the main game class.
     *
     * As the name implies, this will initiate the entire map loading
     * sequence.
     */
    ...
    public static TileMapDatabase getDatabase() { return database; }
